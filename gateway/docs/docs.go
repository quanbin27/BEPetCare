    ...
    "paths": {
        ...
        "/appointments/update-employee": {
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Appointment employee update details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid request, invalid appointment_id or employee_id format",
                        "schema": {
                            "type": "object",
                            "properties": {
                                "error": {
        ...
        "/branches/{branch_id}/products/available": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Product type (FOOD, ACCESSORY, MEDICINE)",
                        "name": "product_type",
                        "in": "query"
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid branch ID or product type",
                        "schema": {
                            "type": "object",
                            "properties": {
                                "error": {
        ...
        "/orders/appointment/{appointment_id}": {
            "get": {
        ...
        "/orders/update-status": {
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Order statusSy status update details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid request, invalid order_id format, or invalid status",
                        "schema": {
                            "type": "object",
                            "properties": {
                                "error": {
        ...
        "/orders/{order_id}": {
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Order ID is required or invalid format",
                        "schema": {
                            "type": "object",
                            "properties": {
                                "error": {
        ...
        "/payments/bank/update-status": {
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Bank payment status update details",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "Bank payment status updated successfully",
                        "schema": {
                            "type": "object",
                            "properties": {
                                "status": {
                    ...
                    "400": {
                        "description": "Invalid request or invalid orderCode format",
                        "schema": {
                            "type": "object",
                            "properties": {
                                "error": {
        ...
        "/products/with_stock": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "List of all products with stock",
                        "schema": {
                            "type": "array",
                            "items": {
                                "type": "object",
        ...
        "/users": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/handlers.UserWithRole"
                            }
                        }
                    },
                    "401": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "User created successfully with user ID",
                        "schema": {
                            "type": "object",
                            "properties": {
                                "userId": {
