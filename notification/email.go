...
func (s *EmailService) SendRegisterEmail(to, confirmLink string) error {
	mailer := gomail.NewMessage()
	mailer.SetHeader("From", s.from)
	mailer.SetHeader("To", to)
	mailer.SetHeader("Subject", "Confirm register")

	// Body email
	body := "Please click the link below to confirm your register:\n" + confirmLink
